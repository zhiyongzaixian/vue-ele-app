  ...
  <div>
    <section v-if="!showLoading" class="shop_container">
      <nav class="goback" @click="goback">
        ...
        <!--</svg>-->
        <!--商家头部导航箭头-->
        <svgImage className="heade_nav" type="#icon-jiantou-copy-copy"/>
      </nav>
          ...
          <section class="buy_cart_container">
            <section @click="toggleCartList" class="cart_icon_num">
              <div class="cart_icon_container" :class="{cart_icon_activity: totalPrice > 0, move_in_cart:receiveInCart}"
                ...
                <!--购物车-->
                <svgImage className="cart_icon" type="#icon-gouwuche"></svgImage>
              </div>
              <div class="cart_num">
                <div>¥ {{totalPrice}}</div>
                  ...
                  <li v-for="(item, index) in cartFoodList" :key="index" class="cart_food_li">
                    ...
                    <section class="cart_list_control">
                        ...
                        @click="removeOutCart(item.category_id, item.item_id, item.food_id, item.name, item.price, item.specs)">
                          ...
                          <!--<svg>-->
                              <!--<use xmlns:xlink="http://www.w3.org/1999/xlink"-->
                                   <!--xlink:href="#icon-jianhao1"></use>-->
                          <!--</svg>-->
                          <svgImage type="#icon-jianhao1"/>
                      </span>
                      ...
                      <span @click="addToCart(item.category_id, item.item_id, item.food_id, item.name, item.price, item.specs)">
                        <svgImage className="cart_add" type="#icon-add"/>
                      </span>
                    </section>
                  </li>
                </ul>
      ...
      <transition name="fadeBounce">
        <div class="specs_list" v-if="showSpecs">
          <header class="specs_list_header">
            ...
            <span  @click="showChooseList">
              <svgImage className="close_tap" type="#icon-x"></svgImage>
            </span>
          </header>
      ...
      .cart_food_li {
        ...
        .cart_list_control {
          ...
          svg {
            ...
            fill: #3190e8;
            border-radius: 0.45rem;/*测试*/
            border: 0.01rem inset #3190e8;
          }
          .specs_reduce_icon {
            fill: #999;
          }
