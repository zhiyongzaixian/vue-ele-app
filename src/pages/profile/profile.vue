    ...
    <section>
        ...
        <router-link :to="userInfo&&userInfo.user_id? '/profile/info' : '/login'" class="profile-link">
          ...
          <span class="privateImage" v-else>
            ...
            <!--<svg class="privateImage-svg" >-->
                <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-yonghutouxiang2"></use>-->
            <!--</svg>-->

            <svgImage className="privateImage-svg" type="#icon-yonghutouxiang2"/>
            ...
            <p>
              <span class="user-icon">
                ...
                <!--<svg class="icon-mobile" fill="#fff">-->
                    <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-shouji1"></use>-->
                <!--</svg>-->
                <svgImage className="icon-mobile" type="#icon-shouji1"/>
              </span>
          ...
          <span class="arrow">
            ...
            <!--右侧箭头-->
            <!--<svg>-->
              <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-jiantou1"></use>-->
            <!--</svg>-->
      ...
      <section class="profile-1reTe">
        ...
        <a href='https://home.m.duiba.com.cn/#/chome/index' class="myorder">
          <aside>
            <!--<svg fill="#fc7b53">-->
              <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-jifen2"></use>-->
            <!--</svg>-->
            <!--积分-->
            <svgImage type="#icon-jifen2"/>
        ...
        <router-link to='/vipcard' class="myorder">
          <aside>
            <!--<svg fill="#ffc636">-->
              <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-huiyuan"></use>-->
            <!--</svg>-->
            <svgImage type="#icon-huiyuan"/>
          </aside>
          <div class="myorder-div">
            <span>饿了么会员卡</span>
            <span class="myorder-divsvg">
      ...
      <section class="profile-1reTe">
        ...
        <router-link to='/service' class="myorder">
          <aside>
            <!--<svg fill="#4aa5f0">-->
              <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-fuwu1"></use>-->
            <!--</svg>-->
            <!--服务-->
            <svgImage type="#icon-fuwu1"/>
          </aside>
          <div class="myorder-div">
            <span>服务中心</span>
            <span class="myorder-divsvg">
        ...
        <router-link to='/download' class="myorder">
          <aside>
            <!--<svg fill="#3cabff">-->
              <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-app1"></use>-->
            <!--</svg>-->
            <!--下载app-->
            <svgImage type="#icon-app1"/>
          </aside>
